"""Code is adapted from https://github.com/earthnet2021/earthnet-models-pytorch/blob/2eabbdcbed76afdc39ac7eba2bc38a95ad1f371b/earthnet_models_pytorch/model/conditioning_layer.py"""
import torch
...
class CrossAttention_Conditioning(nn.Module):
    ...
    def __init__(self, x_channels, c_channels, n_tokens_c, hidden_dim=16, n_heads=16, act="leakyrelu", norm="layer",
        ...
        self.embed_c = MLP2d(c_channels, n_tokens_c * hidden_dim, n_tokens_c * self.embed_dim, act=act,
                             groups=n_tokens_c)
